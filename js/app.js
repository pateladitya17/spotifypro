...
async function getSongs(folder) {
  ...
  songs = [];
  // Example: Extract all anchor tags within the file list
...
async function main() {
  ...
  currentSong.addEventListener("timeupdate", () => {
    document.querySelector(".songtime").innerHTML = `${minutesSeconds(currentSong.currentTime)} /  ${minutesSeconds(currentSong.duration)}`;
